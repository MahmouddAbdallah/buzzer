'use client';
import { ArrowRightLongIcon, CategoryIcon, FAQsIcon, LoadingIcon, ProductIcon, UsersIcon } from '@/app/components/icons';
        ...
        <div className='w-full border rounded-md space-y-3 bg-white'>
            <div className='space-y-2 px-5 pt-5'>
                <div className='space-y-1s'>
                    ...
                    <h6 className='text-2xl font-medium'>Total Category</h6>
                </div>
