'use client';
import { ArrowRightLongIcon, ImageIcon, LoadingIcon, SupplierIcon, UsersIcon } from '@/app/components/icons';
        ...
        <div className='w-full border rounded-md space-y-3 bg-white'>
            <div className='space-y-2 px-5 pt-5'>
                <div className='space-y-1s'>
                    ...
                    <h6 className='text-2xl font-medium'>Total Image Gallery</h6>
                </div>
            ...
            <div className='w-full border-t px-5 py-3'>
                <Link className='text-primary fill-primary flex gap-3' href={'/dashboard/users'}>
...
export default ImageGalleryCount