'use client';
import { ArrowRightLongIcon, LoadingIcon, SupplierIcon, UsersIcon } from '@/app/components/icons';
        ...
        <div className='w-full border rounded-md space-y-3 bg-white'>
            <div className='space-y-2 px-5 pt-5'>
                <div className='space-y-1s'>
                    <SupplierIcon className='size-8' />
                    <h6 className='text-2xl font-medium'>Total Supplier</h6>
                </div>
